...
namespace CoffeeStore.StockManagement.Data
{
        ...
        private void LoadCoffees()
        {
            coffees = new List<Coffee>()
            {
                new Coffee ()
                {
                    ...
                    InventoryAmount=10,
                    InStock = true,
                    DateAdded = new DateTime(2014,1,3),
                ...
                new Coffee ()
                {
                    ...
                    InStock = true,
                    InventoryAmount=100,
                    DateAdded = new DateTime(2015,10,3),
                ...
                new Coffee ()
                {
                    ...
                    InStock = true,
                    InventoryAmount=0,
                    DateAdded = new DateTime(2014,5,5),
                ...
                new Coffee ()
                {
                    ...
                    InStock = true,
                    InventoryAmount=200,
                    DateAdded = new DateTime(2013,9,9),
